...
for _ in range(iterations):
    ...
    def knockout_match_idx(team_a_idx, team_b_idx):
    ...
    for mid in range(73, 89):
        t1, t2 = r32[mid]
        winners_by_match[mid] = knockout_match_idx(t1, t2)
    ...
    champion = knockout_match_idx(winners_by_match[101], winners_by_match[102])
